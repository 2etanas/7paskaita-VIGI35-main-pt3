...
function pagination() {
    ...
    $sortOrderReiksme = (isset($_GET["sortOrder"]) ? $_GET["sortOrder"]: "DESC");                 
    $sortCollumnReiksme = (isset($_GET["sortCollumn"]) ? $_GET["sortCollumn"]: "id");              
    $miestasReiksme = (isset($_GET["miestas"]) ? $_GET["miestas"]: "visi");
